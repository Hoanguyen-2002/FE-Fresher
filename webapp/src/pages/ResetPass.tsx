...
const ForgotPassword: React.FC = () => {
  ...
  return (
    <main className='max-w-screen min-h-28 bg-white pt-10 pb-10 justify-center items-center px-4 sm:px-6 lg:px-8'>
      <div className='container max-w-screen w-full bg-white shadow-lg rounded-lg p-6 sm:p-8'>
        ...
        <Form
          ...
          initialValues={{ email: '' }}
          className='w-11/12 md:w-3/5 justify-self-center'
        >
          {backendError && (
            <Alert
              className='mb-6'
              ...
              ({ getFieldValue }) => ({
                validator(_, value) {
                  ...
                  return Promise.reject(
                    new Error('Mật khẩu mới phải khác mật khẩu cũ!')
                  );
                },
              }),
            ]}
